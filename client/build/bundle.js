	...
	var AccountsBox = React.createClass({
	  ...
	  render: function render() {
	    return React.createElement(
	      ...
	      React.createElement(AccountsList, { accounts: this.props.accounts, onShowAccount: this.props.onShowAccount, onDeleteAccount: this.props.onDeleteAccount })
	    );
	  }
	});
	...
	var AccountsList = React.createClass({
	  ...
	  render: function render() {
	    ...
	    var createAccount = function (account, index) {
	      return React.createElement(Account, { key: index, account: account, onShowAccount: this.props.onShowAccount, onDeleteAccount: this.props.onDeleteAccount });
	    }.bind(this);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Account = React.createClass({
	  ...
	  handleShowClick: function handleShowClick() {
